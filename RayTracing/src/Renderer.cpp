...
Renderer::HitPayLoad Renderer::ClosestHit(const Ray& ray, float hitdistance, int obectindex)
{
	HitPayLoad payload;
	payload.HitDistance = hitdistance;
	payload.ObjectIndex = obectindex;

	const Sphere& closestsphere = m_ActiveScene->Spheres[obectindex];
